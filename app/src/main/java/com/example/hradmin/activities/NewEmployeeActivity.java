...
//                        Log.i("gogpo", "123 " + uemail + upassword);
                    ...
                    myRef.child("users").child(emailformat).setValue(employee);
                    Intent i = new Intent(getApplicationContext(), EmployeesActivity.class);
                    startActivity(i);
                    Toast.makeText(NewEmployeeActivity.this, "New employee succeddfully registered", Toast.LENGTH_SHORT).show();
//                        finish();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(NewEmployeeActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }else if(v.getId() == R.id.btnCancel){
            startActivity(new Intent(NewEmployeeActivity.this, EmployeesActivity.class));
